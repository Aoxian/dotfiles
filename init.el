...
(defvar aoxian/default-font-size 180)
...
(set-face-attribute 'default nil :font "Fira Code Retina" :height aoxian/default-font-size)
...
;;; OrgMode
(defun aoxian/org-mode-setup ()
  (org-indent-mode)
  (variable-pitch-mode 1)
  (visual-line-mode 1))

(defun aoxian/org-font-setup ()
...
(use-package org
  :hook (org-mode . aoxian/org-mode-setup)
  :config
  (setq org-ellipsis " ▾")
  (aoxian/org-font-setup))
...
;;;; visual fill
(defun aoxian/org-mode-visual-fill ()
  (setq visual-fill-column-width 100
        visual-fill-column-center-text t)
  (visual-fill-column-mode 1))

(use-package visual-fill-column
  :hook (org-mode . aoxian/org-mode-visual-fill))
